...
module.exports = {
    ...
    async secondMage(message) {
        ...
        setAdept(reaction, lvl2Embed, emojis, god, message)
...
async function setAdept(adReaction, lvl2Embed, emojis, god, message) {
    ...
    try {
        lvl2Embed.setColor("RANDOM")
            ...
            Your power comes from within. The unctrollable nature of the elements is the same coursing through your veins. \n Will you learn how to tame this power as well?
    \n
    Branches into the **Chaos Elementalist** and the **Druid**`)
        ...
        if (reaction.emoji.name === emojis[0]) {
            lvl2Embed.fields = [];
            setAdept(adReaction, lvl2Embed, emojis, god, message)
        } else if (reaction.emoji.name === emojis[1]) {
            lvl2Embed.fields = [];
            setSummoner(adReaction, lvl2Embed, emojis, god, message)
        } else if (reaction.emoji.name === emojis[2]) {
            lvl2Embed.fields = [];
            setDM(adReaction, lvl2Embed, emojis, god, message)
...
async function setSummoner(adReaction, lvl2Embed, emojis, god, message) {
...
async function setDM(adReaction, lvl2Embed, emojis, god, message) {
