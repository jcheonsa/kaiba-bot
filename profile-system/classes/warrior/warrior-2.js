...
module.exports = {
    ...
    async secondWarrior(client, guildID, userID, lvlChannel, god) {
        try {
            const oneEmoji = "1️⃣"
            const twoEmoji = "2️⃣"
            ...
            var lvl2Embed = new Discord.MessageEmbed()
                .setAuthor("Warrior Second Advancement")
            ...
            setGuard(reaction, lvl2Embed, emojis, god, guildID, userID, lvlChannel)
...
async function setGuard(adReaction, lvl2Embed, emojis, god, guildID, userID, lvlChannel) {
    ...
    try {
        ...
        if (reaction.emoji.name === emojis[0]) {
            ...
            lvl2Embed.fields = [];
            setMA(reaction, lvl2Embed, emojis, god, guildID, userID, lvlChannel)
        } else if (reaction.emoji.name === emojis[2]) {
            lvl2Embed.fields = [];
            setWM(reaction, lvl2Embed, emojis, god, guildID, userID, lvlChannel)
...
async function setMA(adReaction, lvl2Embed, emojis, god, guildID, userID, lvlChannel) {
...
async function setWM(adReaction, lvl2Embed, emojis, god, guildID, userID, lvlChannel) {
    try {
        lvl2Embed.setColor("RANDOM")
