...
module.exports = {
    ...
    async secondThief(message) {
        ...
        try {
            ...
            setNinja(reaction, lvl2Embed, emojis, god, message)
...
async function setNinja(adReaction, lvl2Embed, emojis, god, message) {
...
Branches into the **Wind Shinobi (Physical)** and the **Dragon Shinobi (Mystical)**`)
        ...
        if (reaction.emoji.name === emojis[0]) {
            lvl2Embed.fields = [];
            setNinja(adReaction, lvl2Embed, emojis, god, message)
        } else if (reaction.emoji.name === emojis[1]) {
            lvl2Embed.fields = [];
            setPeddler(adReaction, lvl2Embed, emojis, god, message)
        } else if (reaction.emoji.name === emojis[2]) {
            lvl2Embed.fields = [];
            setCrime(adReaction, lvl2Embed, emojis, god, message)
        } else if (reaction.emoji.name === emojis[3]) {
            lvl2Embed.fields = [];
            setAss(adReaction, lvl2Embed, emojis, god, message)
        }
...
async function setPeddler(adReaction, lvl2Embed, emojis, god, message) {
...
async function setCrime(adReaction, lvl2Embed, emojis, god, message) {
...
async function setAss(adReaction, lvl2Embed, emojis, god, message) {
